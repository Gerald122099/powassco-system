          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
                ...
                />
                <div className="mt-1 text-[11px] text-slate-500">Must be ≥ 0.</div>
              </div>
          ...
          <div className="relative w-full max-w-lg rounded-2xl bg-white shadow-xl border border-slate-200">
            <div className="p-5">
              ...
              <div className="mt-2 text-sm text-slate-600">
                You’re about to update the water billing settings. This will affect
              ...
              <div className="mt-4 rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  ...
                  <div>
                    Due day: <b>{payload.dueDayOfMonth}</b>
                  </div>
                  <div>
                    Grace days: <b>{payload.graceDays}</b>
                  </div>
                  <div>
                    Reading start: <b>{payload.readingStartDayOfMonth}</b>
                  </div>
                  <div>
                    Reading window: <b>{payload.readingWindowDays} days</b>
                  </div>
                </div>
              </div>
