...
const createSchema = z.object({
  ...
  role: z.enum(["admin", "water_bill_officer", "loan_officer", "meter_reader", "plumber", "cashier", "bookkeeper"]),
...
const updateSchema = z.object({
  ...
  role: z.enum(["admin", "water_bill_officer", "loan_officer", "meter_reader", "plumber", "cashier", "bookkeeper"]).optional(),
  status: z.enum(["active", "inactive"]).optional(),
