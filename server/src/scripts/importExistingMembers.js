...
`.trim(),
  ...
  // NOTE: The AR-TNPL block that used to live here was removed after
  // the operator confirmed those rows were imported by mistake (the
  // TNPL list was a duplicate snapshot of sitio members with no
  // sitio assigned, not a separate ledger). 118 records were deleted
  // via src/scripts/removeArTnpl.js. If you ever do need a TNPL group,
  // add a new SITIOS entry with arCategory: "AR-TNPL" and the right
  // member list.
];
